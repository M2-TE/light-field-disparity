...
vk::ShaderModule create_shader_module(DeviceWrapper& device, const unsigned char* data, size_t size)
{
...
vk::ShaderModule create_shader_module(DeviceWrapper& device, ShaderData shader)
{
	vk::ShaderModuleCreateInfo shaderInfo = vk::ShaderModuleCreateInfo()
